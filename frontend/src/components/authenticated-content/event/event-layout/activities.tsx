...
export default function Activities({
    ...
    const handleAssignmentClick = async (assignmentId: any): Promise<void> => {
        const selectedAssignment: any = await showAssignmentAction(
            assignmentId
        );
            ...
            {selectedActivity === null ? (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        ...
                                        today ? (
                                            ...
                                            !isPresenter &&
                                            (assignment.takeAssignmentStatus ===
                                            "SUBMITTED" ? (
                                                <>
                                                    <CircleHelp
                                                        size={18}
                ...
                >
                    ...
                    {activityType === "quiz" && !isPresenter && (
                        ...
                        >
                            عند مغادرة الصفحة، سيتم إرسال إجاباتك تلقائيًا ولن
                            تتمكن من العودة!
                        </motion.div>
                    )}
                </motion.div>
                        ...
                        {!isPresenter ? (
                            <>
                                ...
                                >
                                    <Button
                                        disabled={
                                            selectedActivity.endDate.split(
                                                "T"
                                            )[0] <= today
                                        }
                                        gradient
                                        className={
                                            ...
                                            selectedActivity.startDate.split(
                                                "T"
                                            )[0] > today ||
                                            (activityType === "assignment" &&
                                                selectedActivity.takeAssignmentStatus ===
                                                    "SUBMITTED") ||
                                            (activityType === "quiz" &&
                                                selectedActivity.takeQuizStatus ===
                                                    "SUBMITTED")
                                                ? "hidden"
                                                : ""
                                        }
