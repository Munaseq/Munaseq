...
exports.QuizQuestionDto = void 0;
const openapi = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
const client_1 = require("@prisma/client");
class QuizQuestionDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { text: { required: true, type: () => String }, questionType: { required: true, type: () => Object }, options: { required: true, type: () => Object, format: "json" }, correctAnswer: { required: true, type: () => String } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], QuizQuestionDto.prototype, "questionType", void 0);
__decorate([
