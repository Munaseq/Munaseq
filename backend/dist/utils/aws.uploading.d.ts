...
export declare function sendEmailSendGrid(firstName: string, startEventDate: string, eventTitle: string, eventId: string, userEmail: string, eventCreatorEmail: string): Promise<string>;
